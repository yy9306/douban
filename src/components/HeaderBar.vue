<template>
  <div class="header-bar">
    <h1 class="title">
        <router-link  to="/pages/home">豆瓣</router-link>
    </h1>
    <ul class="nav">
      <li>
          <router-link style="color: #2384E8" to="/pages/movie">电影</router-link>
      </li>
      <li>
          <router-link style="color: #9F7860" to = "/pages/book">图书</router-link>
      </li>
      <li>
          <router-link style="color: #E4A813" to = "/pages/status">广播</router-link>
      </li>
      <li>
          <router-link style="color: #2AB8CC" to = "/pages/group">小组</router-link>
      </li>
    </ul>
